    ...
    return(
        ...
        <aside>
            ...
            <ul className="mainMenu">
                ...
                <li className={splitPath[2] === 'pr-video' ? 'pr_video active' : 'pr_video'}>
                    <span onClick={() => router.push(`/admin/pr-video/promotion-video-list`)}>PR Video</span>
                    <ul className="subMenu">
                        <li className={splitPath[3] === 'promotion-video-list' || splitPath[3] === 'promotion-video' ? 'active' : ''} onClick={() => router.push(`/admin/pr-video/promotion-video-list`)}>
                            <span>홍보영상 관리</span>
                        </li>
                    </ul>
                </li>
