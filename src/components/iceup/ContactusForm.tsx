                ...
                <div className="row col-md-11">
                    <form className="contact-form needs-validation" method="post">
                        ...
                        <div className="row gx-4">
                            <h3 className="display-7 mb-5"><span className="dots-number bg-navy text-white text-center fs-16 d-inline-block">1</span> {language.faq_2_1} <span className="text-red">*</span></h3>
                            <div className="col-md-4">
                                <div className="form-floating mb-4">
                                    <input required type="text" name="company" onChange={handleChange} id="company_name" placeholder={language.faq_3} className="form-control"/>
                                    <label htmlFor="company_name">{language.faq_3} *</label>
                                </div>
                            </div>

                            <div className="col-md-4">
                                <div className="form-floating mb-4">
                                    <input required type="text" name="name" onChange={handleChange} id="customer_name" placeholder={language.faq_4} className="form-control"/>
                                    <label htmlFor="customer_name">{language.faq_4} *</label>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="form-floating mb-4">
                                    <input required type="text" name="position" onChange={handleChange} id="rank_name" placeholder={language.faq_5} className="form-control"/>
                                    <label htmlFor="rank_name">{language.faq_5} *</label>
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="form-floating mb-4">
                                    <input required type="text" name="number" onChange={handleChange} id="email" placeholder={language.faq_6} className="form-control"/>
                                    <label htmlFor="rank_name">{language.faq_6} *</label>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4">
                                <div className="form-floating mb-4">
                                    ...
                                    />
                                    <label htmlFor="form_email">{language.faq_7} *</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row gx-4 mt-8">
                            <h3 className="display-7 mb-5"><span className="dots-number bg-navy text-white text-center fs-16 d-inline-block">3</span> {language.faq_14} <span className="text-red">*</span></h3>
